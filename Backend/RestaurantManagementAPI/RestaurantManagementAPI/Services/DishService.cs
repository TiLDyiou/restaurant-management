...
namespace RestaurantManagementAPI.Services
{
    public class DishService : IDishService
    {
        ...
        public async Task<ServiceResult<MonAnDto>> GetDishByIdAsync(string maMA)
        {
            ...
            if (m == null) 
                return ServiceResult<MonAnDto>.Fail("Không tìm thấy món");
            return ServiceResult<MonAnDto>.Ok(new MonAnDto 
            { 
                MaMA = m.MaMA, 
                TenMA = m.TenMA, 
                DonGia = m.DonGia, 
        ...
        public async Task<ServiceResult> UpdateDishAsync(string maMA, UpdateMonAnDto dto)
        {
            ...
            if (monAn == null) 
                return ServiceResult.Fail("Món ăn không tồn tại");
        ...
        public async Task<ServiceResult> SoftDeleteDishAsync(string maMA)
        {
            ...
            if (monAn == null || !monAn.TrangThai) 
                return ServiceResult.Fail("Món không tồn tại");
